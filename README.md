...
- Creates an EC2 instance with access secured to the local host;
  (Refer to "N.B." section below for specifics of deployment to custom VPC.)
...
N.B.
AS OF VERSION 3.0.1 ON, THE MODULE DEPLOYS THE EC2 INSTANCE(S) INTO A VPC IT CREATES TO RUN THE INSTANCE(S) IN.
